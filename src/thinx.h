...
const char * THINX_APP_VERSION = "thinx-arduinoc-2.1.112:2017-11-01";
const char * THINX_CLOUD_URL = "thinx.cloud";
const char * THINX_COMMIT_ID = "771478cc401ce3285c066e20b52993d7e3979075";
const char * THINX_FIRMWARE_VERSION = "thinx-arduinoc-2.1.112:2017-11-01";
const char * THINX_FIRMWARE_VERSION_SHORT = "90";
