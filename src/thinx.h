...
const char * THINX_APP_VERSION = "thinx-lib-esp8266-arduino:2.7.231:2019-06-03";
const char * THINX_CLOUD_URL = "staging.thinx.cloud";
const char * THINX_COMMIT_ID = "0";
const char * THINX_FIRMWARE_VERSION = "thinx-lib-esp8266-arduino:2.7.231";
const char * THINX_FIRMWARE_VERSION_SHORT = "2.7.231";
const char * THINX_MQTT_URL = "thinx.cloud";
const char * THINX_OWNER = "0";
const char * THINX_PLATFORM  = "arduino"; // will be overridden on build
