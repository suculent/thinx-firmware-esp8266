...
const char * THINX_APP_VERSION = "thinx-lib-esp8266-arduino:2.1.168:2018-03-16";
const char * THINX_CLOUD_URL = "thinx.cloud";
const char * THINX_COMMIT_ID = "16b6719284cb56c90db02c289c80aa181df0e906";
const char * THINX_FIRMWARE_VERSION = "thinx-lib-esp8266-arduino:2.1.168";
const char * THINX_FIRMWARE_VERSION_SHORT = "2.1.168";
