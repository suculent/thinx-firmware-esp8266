...
private:
    ...
    unsigned long checkin_interval = 3600 * 1000;          // next timeout millis()
    unsigned long checkin_time = 3600 * 1000;  // can be set externaly, defaults to 1h
