...
def mqtt_connect():
  ...
  client.publish("/home", bytes("OLED AIR-Sensor MQTT/ELK APP v4 listening to /display/2/", 'utf-8'))
...
def boot_logo(display):
  print("OLED AIR-Sensor MQTT/ELK APP v4")
  display.fill(0)    
  display.show()
...
while True: 
  ...
  while True:
    ...
    display.show()        
    message = '{{ "AIR" : {} }}'.format(str(adc_data))
    print(message)
